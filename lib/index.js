	...
	const ReactNative = {
	  ...
	  addons: {
	    ...
	    get batchedUpdates() {
	      ...
	      return __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react/lib/ReactUpdates\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).batchedUpdates;
	    },
	    get createFragment() {
	      if (__DEV__) {
	        addonWarn('createFragment', 'react-addons-create-fragment');
	      }
	      return __webpack_require__(39).create;
	    },
	    get update() {
	      if (__DEV__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(34);
	var ReactStateSetters = __webpack_require__(35);
